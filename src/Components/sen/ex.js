...
import Sensibilisation from "../Sensabilisation/Sensabilisation";
export default function FeatureImg({ ImgSource }) {
  return (
    <>
    
      <div id="products" className="feature-section " style={{backgroundColor:"#cac7c7"}}>
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-md-8">
              <div className="section-heading text-center mb-5">
                ...
                <h2 style={{color:"hsla(30, 59%, 45%, 0.902)"}}> THE DIFFERENT TYPES OF SKIN CANCER</h2>
                <p style={{ fontSize: "20px" }}>
                  <table>
                    <tr >
                      ...
                      <span style={{ textDecoration: "underline" }}>Basal cell carcinoma</span> is the most common type of skin cancer and commonly affects sun-exposed areas.
                ...
                <p style={{ fontSize: "20px" }}>
                  <table>
                    <tr>
                      ...
                      <td style={{ marginLeft: "20px" }}>
                      <span style={{ textDecoration: "underline" }}>Squamous cell carcinoma </span>is a fast-growing type of skin cancer.
                ...
                <p style={{ fontSize: "20px" }}>
                  <table>
                    <tr>
                      ...
                      <td style={{ marginLeft: "20px" }}>
                      <span style={{ textDecoration: "underline" }}>Melanoma </span> is a dangerous form of skin cancer that can occur on sun-exposed or covered skin.
          ...
          <div className="row row-grid align-items-center">
            <h2 style={{ textAlign: "center"  , color:"hsla(30, 59%, 45%, 0.902)"}}>THE RISKS OF DEVELOPING SKIN CANCER</h2>
            <br></br>
 ...
 <div class="col-lg-5" style={{backgroundColor:"#F5EEEA",marginLeft:"100px",marginTop:"30px",display:"flex"}}>
      ...
      <div class="col-sm-5 col-md-6" style={{width:"60%"}}><h6 style={{marginTop:"15%"}}>The use of cosmetic products containing chemical ingredients.</h6></div>
        ...
        <h2 style={{ textAlign: "center" ,marginTop:"60px" , color:"hsla(30, 59%, 45%, 0.902)"}}>HOW CAN I DETECT SKIN CANCER?</h2>

        <h6 style={{ marginTop: "40px", marginLeft: "50px", fontSize:"25px" }}>
          ...
          <h6 style={{ marginLeft: "130px" , fontSize:"25px" , marginTop:"20px"}}>
