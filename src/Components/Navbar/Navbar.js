...
function ColorSchemesExample() {
  ...
  return (
    <>
      ...
      <Navbar expend="lg">
        <Container>
        <Navbar.Brand   style={{fontSize:40,color:'hsla(30, 59%, 45%, 0.902)' , marginLeft:"-20px"} } href="#home"    >
          <img src={LOG} />
        ...
        <Navbar.Collapse id="basic-navbar-nav" style={{height: '400%' }}>
          <Nav className="ml-auto" >
            ...
            <NavLink className="in" href="#info" style={{marginTop:"-5px"}} > <BiDonateHeart/> Sensitization</NavLink>
